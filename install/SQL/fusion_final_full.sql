...
-- Records of articles
-- ----------------------------
INSERT INTO `articles` VALUES ('1', 'Welcome to your new Fusion CMS Remix powered website!', 'Your website has been successfully installed and. I DJBoxer sincerely hope that you will have a nice time using it.<div><br></div><div>To proceed, log into the administrator panel using an administrator account and the security code you specified during the installation.</div><div><br></div><div>If you run into problems, please contact me via the <a href=\"https://github.com/DJBoxer/FusionCMS-Remix/issues" target=\"_blank\">Support</a>.</div><div><br></div><div>Best regards,</div><div>DJBoxer</div>', '1344607279', '1', '', '-1');
